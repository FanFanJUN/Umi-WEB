...
import {
  ...
  StrategicPurchaseConfig, MaterialSourceArr, MaterialSourceConfig,
} from '../../commonProps';
...
export default function() {
  ...
  const formItems = [
    ...
    { title: '物料来源', key: 'materialSource', type: 'list', props: MaterialSourceConfig },
  ...
  const columns = [
    ...
    {
      title: '技术资料附件',
      dataIndex: 'technicalDataFileIdList',
      width: 140,
      ellipsis: true,
      render: (v) => <Upload type='show' entityId={v}>查看</Upload>,
    },
