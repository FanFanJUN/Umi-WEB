...
// 根据物料代码获取适用范围
export const findRangeListByMaterialCode = {
  remotePaging: true,
  store: {
    type: 'POST',
    autoLoad: false,
    url: `${baseUrl}/environmentStandardLimitMaterialRelation/findByProtectionCodeOrMaterialCodeOrRangeCode`,
    params: {
    }
  },
  rowKey: 'practicalRangeCode',
  reader: {
    name: 'practicalRangeName',
    field: ['practicalRangeId', 'practicalRangeCode'],
    description: 'practicalRangeCode',
  },
  placeholder: '选择适用范围',
};
// 根据适用范围获取物料代码
export const findMaterialListByRangeCode = {
  remotePaging: false,
  store: {
    type: 'POST',
    autoLoad: false,
...
// 根据适用范围获取物料名称
export const findMaterialNameListByRangeCode = {
  remotePaging: false,
  store: {
    type: 'POST',
    autoLoad: false,
