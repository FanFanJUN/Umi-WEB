  ...
  return <Fragment>
    ...
    <Row>
      <Col span={12} className={styles.rl}>
        <SplitPartsTable environmentalProtectionCode={originData.environmentalProtectionCode} wrappedComponentRef={splitRef} dataList={splitDataList} setSelectedSpilt={setSelectedSpilt} setSplitDataList={setSplitDataList} isView={isView} />
      </Col>
