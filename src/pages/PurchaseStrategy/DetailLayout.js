            ...
            >
              {
                getFieldDecorator('submitList')(
                  <UserSelect disabled={type === "detail"} style={{ width: "100%", zIndex: 10 }} mode="tags" wrapperStyle={{ width: 800 }} placeholder="选择呈报人员" name='submitList' reader={{ name: 'userName', field: ['code'] }} form={form} />
                )
              }
            </Item>
          </Col>
