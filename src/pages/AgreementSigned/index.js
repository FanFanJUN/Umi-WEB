...
import {
  agreementSignedCheck as CHECK_METHOD,
  agreementSignedExport as EXPORT_METHOD,
  agreementSignedSaveList as SAVE_LIST_METHOD,
  agreementSignedSaveOne as SAVE_ONE_METHOD,
  agreementSignedRemove as REMOVE_METHOD
...
const { Search } = Input;
/** 配置修改部分 begin */
const MAIN_KEY_PREFIX = 'AGREEMENT_SIGNED_MAIN_'
const TABLE_DATASOURCE_QUERY_PATH = `${recommendUrl}/api/samBafAgreementSignedService/findByPage`;
...
const FIELDS = [
  ...
  },
  {
    ...
    labelOptions: [
      ...
      {
        value: 'PARTIAL_SIGNING',
        text: '部分签订'
      },
      {
        value: 'SIGNED_IN_FULL',
        text: '完全签订'
      }
    ],
    option: {
...
const COLUMNS = [
  ...
  {
    title: '质量赔偿和环保协议的签订',
    dataIndex: 'agreementSignedEnumRemark',
  }
];
const TFL = [
  {
