...
import {
  environmentalProblemCheck as CHECK_METHOD,
  environmentalProblemExport as EXPORT_METHOD,
  environmentalProblemSaveList as SAVE_LIST_METHOD,
  environmentalProblemSaveOne as SAVE_ONE_METHOD,
  environmentalProblemRemove as REMOVE_METHOD
...
const { Search } = Input;
/** 配置修改部分 begin */
const MAIN_KEY_PREFIX = 'ENVIRONMENTAL_PROBLEM_MAIN_'
const TABLE_DATASOURCE_QUERY_PATH = `${recommendUrl}/api/bafEnvironmentalProblemService/findByPage`;
const DEVELOPER_ENV = (process.env.NODE_ENV === 'development').toString();
const { authAction, getUUID } = utils;
const FILENAME = '环境问题上传模板.xlsx';
const DOWNLOADNAME = '环境问题.xlsx'
