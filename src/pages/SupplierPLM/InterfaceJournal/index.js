...
function SupplierConfigure() {
    ...
    // 高级查询配置
    const formItems = [
        { title: '业务单元', key: 'Q_EQ_unitCode', type: 'list', props: buListCode },
        { title: '重发状态', key: 'Q_EQ_unitName', type: 'list', props: Retransmission },
        { title: '请求状态', key: 'Q_EQ_supplierCode', type: 'list', props: requestStart },
        { title: '请求时间', key: 'Q_EQ_plmStatus', type: 'datePicker' },
        { title: '流程名称', key: 'Q_EQ_status', type: 'list', props: PLMType },
        { title: '重发人', key: 'Q_EQ_status', props: { placeholder: '输入重发人' } }
    ];
    return (
        <>
            <Header
