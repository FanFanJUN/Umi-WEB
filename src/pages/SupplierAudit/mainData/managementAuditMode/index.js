...
const Index = () => {
  ...
  const buttonClick = async (type) => {
    switch (type) {
      case 'add':
        setData((value) => ({ ...value, visible: true, title: '审核方式管理新增', type: 'add' }));
        break;
      case 'edit':
        setData((value) => ({ ...value, visible: true, title: '审核方式管理编辑', type: 'edit' }));
        break;
      case 'delete':
        await deleteData();
        break;
