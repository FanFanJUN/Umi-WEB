      ...
      <div className={styles.bgw}>
        ...
        <div className={styles.content}>
          {type !== 'add' && (
            <Row>
              <Col span={12}>
                <FormItem label="年度审核计划号" {...formLayout} style={FormItemStye}>
                  {isView ? (
                    <span>{data.reviewPlanYearCode}</span>
                  ) : (
          ...
          <Row>
            <Col span={12}>
              ...
              <FormItem label="拟制公司" {...formLayout} style={FormItemStye}>
                {isView ? (
                  <span>{data.applyCorporationName}</span>
                ) : (
            ...
            <Col span={12}>
              ...
              <FormItem label="拟制部门" {...formLayout} style={FormItemStye}>
                {isView ? (
                  <span>{data.applyDepartmentName}</span>
                ) : (
            ...
            <Col span={12}>
              ...
              <FormItem label="拟制人" {...formLayout} style={FormItemStye}>
                {isView ? (
            ...
            <Col span={12}>
              <FormItem label="联系方式" {...formLayout} style={FormItemStye}>
                {isView ? (
                  <span>{data.applyTel}</span>
                ) : (
          ...
          <Row>
            <Col span={12}>
              <FormItem label="年度" {...formLayout} style={FormItemStye}>
                {isView ? (
                  <span>{data.applyYear + ' 年'}</span>
                ) : (
                  getFieldDecorator('applyYear', {
          ...
          <Row>
            <Col span={24}>
              <FormItem label="拟制说明" {...formLongLayout} style={FormItemStye}>
                {isView ? (
                  <span>{data.reviewPlanYearName}</span>
                ) : (
          ...
          <Row>
            <Col span={24}>
              <FormItem label="备注" {...formLongLayout} style={FormItemStye}>
                {isView ? (
          ...
          <Row>
            <Col span={24}>
              <FormItem {...formLongLayout} label={'附件'} style={FormItemStye}>
