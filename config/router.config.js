export default [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/material/Cognizance/AdmitEdit/index', component: './MaterialCognizance/Cognizance/AdmitEdit/index', title: '实物认定准入单创建编辑' },
      { path: '/material/Cognizance/ManualAdd/index', component: './MaterialCognizance/Cognizance/ManualAdd/index', title: '实物认定合格供应商名录创建' },
      { path: '/material/Cognizance/ManualEdit/index', component: './MaterialCognizance/Cognizance/ManualEdit/index', title: '实物认定实物认定计划编辑' },
      { path: '/material/Cognizance/ManualDetail/index', component: './MaterialCognizance/Cognizance/ManualDetail/index', title: '实物认定实物认定计划明细' },
      ...
      { path: '/material/Cognizance/AdmitAdd/index', component: './MaterialCognizance/Cognizance/AdmitAdd/index', title: '实物认定计划准入单创建' },
      { path: '/material/Cognizance/PCNModifyAdd/index', component: './MaterialCognizance/Cognizance/PCNModifyAdd/index', title: '实物认定PCN变更创建' },
      { path: '/material/Cognizance/PCNModifyEdit/index', component: './MaterialCognizance/Cognizance/PCNModifyEdit/index', title: '实物认定PCN变更创建编辑' },
    ]
  },
  {
    path: '/gradeSystem',
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/supplier/recommend/fillIn/data/detail',
        component: './SupplierRecommendDemand/RecommendDataDetail',
        title: '推荐资料填报明细'
      },
      {
